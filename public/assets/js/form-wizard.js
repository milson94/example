var FormWizard = function() {
	...
	var onShowStep = function(obj, context) {
        ...
        $('.processar').show();
        var pergunta_id = $(this).attr('data-pergunta');
        var pontuacao = $(this).attr('data-pontuacao');
        ...
        var data = 'pergunta_id=' + pergunta_id + '&alternativa=' + alternativa + '&exame_id=' + exame_id + '&resul=' + resul + '&pontuacao=' + pontuacao;
        $.ajax({//create an ajax request to display.php
            data: data,
            url: '/exames/responder',
            type: "post",
            headers: {
                'X-CSRF-TOKEN': token
            },
